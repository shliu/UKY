 ...
 *
 *  Stage A Goals:
 *      Lexical and syntactical modifications
 *      C++ style variable names
 *      C++ style - single and multiple line
 *      Symbol table - use the provided symbol table.cc
 *      Add syntax for declarations for:
 *          integer (int) and double variables/constants.
